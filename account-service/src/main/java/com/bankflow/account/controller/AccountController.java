...
public class AccountController {
    ...
    // GET /api/v1/accounts/balance?email=user@example.com
    @GetMapping("/balance")
    public ResponseEntity<ApiResponse<BigDecimal>> getBalanceByEmail(
            @RequestParam String email) {

        log.info("REST request to get balance for email: {}", email);
